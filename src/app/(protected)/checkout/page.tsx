...
const CheckoutPage: FC = () => {
    ...
    api
      ...
      .then(res => {
        if (res.data.success) {
          ...
          setShippingCost(first?.cost || 0);
        }
      })
      .catch(console.error)
      .finally(() => setLoadingShipping(false));
  }, [form.country, form.pin, setShippingCost]);

  function handleChange(field: string, value: any) {
    setForm(prev => ({ ...prev, [field]: value }));
  }
  function handleBillingChange(field: string, value: any) {
  ...
  async function handleSubmit() {
    ...
    const payload = {
      items: items.map(i => ({ id: i._id, qty: i.quantity })),
      form,
      ...
      <div className="lg:col-span-2 space-y-8">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-2">
              ...
              <Select onValueChange={v => handleChange("country", v)} value={form.country}>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input id="apartment" value={form.apartment} onChange={e => handleChange("apartment", e.target.value)} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <Select onValueChange={v => handleChange("state", v)} value={form.state}>
                  <SelectTrigger><SelectValue placeholder="Select state" /></SelectTrigger>
                  <SelectContent>
                    <SelectItem value="Andaman and Nicobar">Andaman and Nicobar</SelectItem>
                    {/* TODO: list other states */}
                  </SelectContent>
                </Select>
              </div>
              <div>
                <Label htmlFor="pin">PIN code</Label>
                <Input id="pin" value={form.pin} onChange={e => handleChange("pin", e.target.value)} />
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <RadioGroup onValueChange={v => handleChange("paymentMethod", v)} value={form.paymentMethod} className="space-y-2">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="billFirst" value={billing.firstName} onChange={e => handleBillingChange("firstName", e.target.value)} />
                  </div>
                  <div>
                    <Label htmlFor="billLast">Last name</Label>
                    <Input id="billLast" value={billing.lastName} onChange={e => handleBillingChange("lastName", e.target.value)} />
                  </div>
                </div>
                <div>
                  <Label htmlFor="billAddr">Address</Label>
                  <Input id="billAddr" value={billing.address} onChange={e => handleBillingChange("address", e.target.value)} />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                ...
                <div>
                  ...
                  <Input id="billPhone" value={billing.phone} onChange={e => handleBillingChange("phone", e.target.value)} />
                </div>
              </div>
            )}
          </CardContent>
